...
export const teachingServices = [
  ...
  { title: "Teaching 6", icon: teachingTechStack6 },
  { title: "Teaching 7", icon: teachingTechStack7 },
  { title: "Teaching 8", icon: teachingTechStack8 },
  { title: "Teaching 9", icon: teachingTechStack9 },
  { title: "Teaching 10", icon: teachingTechStack10 },
  { title: "Teaching 11", icon: teachingTechStack11 },
  { title: "Teaching 12", icon: teachingTechStack12 },
  { title: "Teaching 13", icon: teachingTechStack13 },
];
